...
\begin{itemize}
\item You must use the 2019 AAAI Press \LaTeX{} style file and the aaai.bst bibliography style file, which are located in the 2019 AAAI Author Kit (aaai19.sty and aaai.bst).
...
The copyright notice automatically appears if you use aaai19.sty. It has been hardcoded and may not be disabled.
